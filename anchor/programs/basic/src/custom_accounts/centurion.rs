...
pub struct Centurion {
    pub owner: Pubkey,                // Owner of this centurion account
    ...
    pub deposit_tvl: u64,             // Total value locked across all deposits
    #[max_len(20)]
    pub testudo_pdas: Vec<Pubkey>, // Array of PDA for each testudo account
}

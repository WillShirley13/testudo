...
export type Testudo = {
	...
	instructions: [
		{
			name: "addMintTestudo";
			discriminator: [200, 247, 67, 235, 127, 248, 93, 11];
			accounts: [
				{
					name: "authority";
					writable: true;
		...
		{
			name: "createTestudo";
			discriminator: [185, 80, 13, 69, 80, 88, 212, 32];
			accounts: [
				{
					name: "authority";
					writable: true;
		...
		{
			name: "deleteTestudo";
			discriminator: [220, 125, 185, 47, 248, 252, 238, 110];
			accounts: [
				{
					name: "authority";
					writable: true;
		...
		{
			name: "initCenturion";
			discriminator: [58, 133, 196, 61, 206, 17, 58, 64];
			accounts: [
				{
					name: "authority";
					writable: true;
		...
		{
			name: "initLegate";
			discriminator: [221, 211, 219, 66, 207, 113, 50, 227];
			accounts: [
				{
					name: "authority";
					writable: true;
		...
		},
		{
			...
			discriminator: [238, 120, 102, 92, 157, 240, 77, 118];
			accounts: [
				{
					name: "authority";
					writable: true;
		...
		},
		{
			...
			discriminator: [183, 108, 192, 5, 181, 251, 228, 2];
			accounts: [
				{
					name: "authority";
					writable: true;
		...
		},
		{
			...
			discriminator: [202, 184, 37, 142, 189, 21, 26, 193];
			accounts: [
				{
					name: "authority";
					writable: true;
		...
		},
		{
			...
			discriminator: [254, 230, 17, 116, 161, 54, 93, 145];
			accounts: [
				{
					name: "authority";
					writable: true;
		...
		},
		{
			...
			discriminator: [36, 27, 114, 22, 47, 242, 235, 148];
			accounts: [
				{
					name: "authority";
					writable: true;
	...
	accounts: [
		{
			name: "centurion";
			discriminator: [213, 163, 239, 54, 208, 69, 71, 100];
		},
		{
			name: "legate";
			discriminator: [25, 12, 152, 251, 62, 237, 26, 112];
		}
	];
	errors: [
		{

...
async function main() {
	...
	console.log("Updating treasury to:", treasuryKeypair.publicKey.toBase58());
	const tx = await program.methods
		.updateTreasury(treasuryKeypair.publicKey)
		.accounts({
	...
	console.log("New treasury:", updatedLegate.treasuryAcc.toBase58());
}

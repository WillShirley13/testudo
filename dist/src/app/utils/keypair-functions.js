...
exports.SecureKeypairGenerator = void 0;
 ...
 */
class SecureKeypairGenerator {
    constructor() {
        // Use the standard BIP39 wordlist (2048 words)
        this.wordlist = bip39.wordlists.english;
        // Security parameters
        this.PBKDF2_ITERATIONS = 250000;
        this.SALT_PREFIX = 'secure-mnemonic-solana-keypair-v1';
     ...
     */
    async deriveKeypairFromWords(words, userPublicKey, userNumberPin = "") {
        // Validate input
        const validLengths = [5, 6, 8, 10, 12];
        ...
        const keypair = web3_js_1.Keypair.fromSeed(Buffer.from(hashResult.hash));
        return { keypair, words: normalizedWords };
    }
    /**
     * Signs a message using the keypair derived from a mnemonic phrase
     */
    async signMessage(message, words, userPublicKey, userNumberPin = "") {
     ...
     */
    getEnhancedSecurityInfo(wordLength, numberLength) {
        const baseInfo = this.securityInfo[wordLength];
        if (!baseInfo)
            return null;
...
exports.SecureKeypairGenerator = SecureKeypairGenerator;
